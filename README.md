...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/crimson-surf-ac08)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-surf-ac08
```

A live public deployment of this template is available at [https://crimson-surf-ac08.templates.workers.dev](https://crimson-surf-ac08.templates.workers.dev)
